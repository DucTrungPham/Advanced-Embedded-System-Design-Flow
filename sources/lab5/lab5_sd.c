...
#define LAB3_BITFILE_LEN  0x03dbb00
...
#define LAB3_ELFBINFILE_LEN  0x00008008
#define LAB1_ELF_EXEC_ADDR  0x002005b8 // ELF main() entry point
#define LAB3_ELF_EXEC_ADDR  0x006005b8
