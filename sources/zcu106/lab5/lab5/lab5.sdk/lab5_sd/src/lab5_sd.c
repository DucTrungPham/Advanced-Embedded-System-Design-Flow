...
#define LAB1_BITFILE_LEN  0x126aa6b // BIN formatted BITfile length
#define LAB3_BITFILE_LEN  0x126aa6b
#define LAB1_ELFBIN_ADDR  0x2000000 // BIN formatted ELF address
#define LAB3_ELFBIN_ADDR  0x6000000
#define LAB1_ELFBINFILE_LEN  0x0000a048 // BIN formatted ELF length
#define LAB3_ELFBINFILE_LEN  0x0000a048
#define LAB1_ELF_EXEC_ADDR  0x2000f6c // ELF main() entry point
#define LAB3_ELF_EXEC_ADDR  0x6000f6c
