...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01010B00
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD07012C 0x7F1F031F 0x1007010E
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x7BFF3FFF 0x52240000
    ...
    mask_write 0XFF180208 0xFFF00000 0x00B00000
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410014 0x00000070 0x00000020
		# : CHECKING PLL LOCK
